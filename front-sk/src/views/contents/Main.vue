        ...
        <v-row>
            ...
            <v-col cols="12" md="4">
                ...
                >
                    ...
                    <v-img
                        height="250"
                        src="https://file.mk.co.kr/mkde_7/N0/2019/09/20190911_4227416_1568180445.jpg"
                    ></v-img>
                    <md-button class="md-icon-button">
                        <md-icon>favorite_border</md-icon>
                    </md-button>
                    ...
                    <v-card-title style="line-height: 0.5rem"
                        >스타벅스</v-card-title
                    >
                    ...
                    <v-card-text>
                        ...
                        <div>
                            커피가 밥값보다 비쌈 근데 커피는 맛있음 근데
                            밥값보다 비쌈 근데 커피는 괜찮음..근데 그돈이면
                            국밥사먹음
                        </div>
                    </v-card-text>
                </v-card>
