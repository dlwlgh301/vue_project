...
>>>>>>> f1b68e2a886071119a4465b169475bfec73ee02c
                    ...
                    <div class="profile2-user-settings">
                        ...
                        <button class="btn2 profile2-edit-btn" v-on:click="updateuser">Edit Profile</button>
                        <button class="btn2 profile2-delete-btn" v-on:click="deleteuser">회원탈퇴</button>
                    </div>
                    ...
                    >
                        <li>
                            <ul style="margin-left:25px; cursor: pointer;">
                                ...
                                <div
                                    class="myfollowList"
                                    @click="FollowListBtnCheck(index)"
                                    v-show="followCheck[index] == false"
                                >
                    ...
                    >
                        <li>
                            <ul style="margin-left:25px; cursor: pointer;">
                                ...
                                >{{ item.followingnickName }}</span>

                                <div
                                    class="myfollowList"
                                    @click="FollowingListBtnCheck(index)"
                                    v-show="followingCheck[index] == false"
                                >
                                    <div class="icon-instagram"></div>팔로우
                                </div>
                                <div
                                    class="myfollowingList"
                                    @click="FollowingListBtnCheck(index)"
                                    v-show="followingCheck[index] == true"
                                >
                                    <div class="icon-ok"></div>팔로잉
                                </div>
                            </ul>
